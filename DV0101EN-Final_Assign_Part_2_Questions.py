...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'text-align': 'center', 'color': '#503D36', 'font-size': 24}),#May include style for title
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mon_sales, 
                x='Month',
                y='Automobile_Sales',
                title="Monthly Automobile Sales in Year {}".format(selected_year)))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                                values='Advertising_Expenditure',
                                names='Vehicle_Type',
                                title='Total expenditure share by vehicle type during the year {}'.format(selected_year)))
